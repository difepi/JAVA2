...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Задание 1.
        SetofWords word = new SetofWords("радость", "счастье", "улыбка", "красота", "чудо", "кайф", "отдых",
        ...
        word.RepetiotionWords();
        //Задание 2.

        System.out.println(TEXTCOLOR + "\n\nЗадание 1. Урок 3. Курс Java 2." + TEXTCOLOR_RESET);
        PhoneBook book = new PhoneBook();
        book.add("Шершуков","89093657745"); book.add("Самохвалова","8905345334");
        book.add("Павлова","774456555345 ");book.add("Оверченков","89023433355");
        book.add("Фельдман","+79084563219"); book.add("Афанасьев","+79803699049");
        book.add("Заварова","+79536144107"); book.add("Фельдман","89093554672");
        book.add("Шенкевич","8(4862)78-03-70");

        System.out.println("найден следующий телефонный номер (Заварова): " + book.get("Заварова"));

        book.add("Фельдман","89997773467"); book.add("Заварова","+7 (953) 614-41-07");
